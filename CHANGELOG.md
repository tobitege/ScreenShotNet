...
- `capture_window_screenshot` now trims the visible DWM window border after resolving extended frame bounds so full-window captures no longer include a few pixels of desktop background around the sides and bottom.

## [1.0.1] - 2026-03-23

### Fixed

- Added empty MCP resource and resource-template list handlers so clients like Roo Code can probe optional discovery endpoints without logging warning messages.
