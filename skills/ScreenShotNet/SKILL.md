...
description: Capture region screenshots with ScreenShotNet, including delay, output target, and optional watermark overlay
---
...
- Exactly one target: `--clipboard` or `--file fullPath`
- Optional watermark:
  - `--watermark-text "text"`
  - `--watermark-pos x,y`
...
- Reject missing target or both targets together.
